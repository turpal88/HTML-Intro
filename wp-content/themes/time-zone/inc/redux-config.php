...
require_once get_template_directory() . '/inc/redux-components/home/watch-of-choise.php';
require_once get_template_directory() . '/inc/redux-components/home/shop-method.php';

Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Страница "About"', 'your-textdomain-here' ),
		'id'               => 'about',
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	)
);
require_once get_template_directory() . '/inc/redux-components/about/top-section.php';
require_once get_template_directory() . '/inc/redux-components/about/second-section.php';

Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Страница "Contact"', 'your-textdomain-here' ),
		'id'               => 'contact',
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
	)
);
require_once get_template_directory() . '/inc/redux-components/contact/top-section.php';
require_once get_template_directory() . '/inc/redux-components/contact/contact-info.php';
...
require_once get_template_directory() . '/inc/redux-components/footer/copyright.php';
